// V2.1 - Line follower với PID controller + cảm biến màu TCS34725
...
float Kp = 136.0;
float Kd = 99.0;
float Ki = 0.5;   // Bắt đầu với một giá trị Ki nhỏ
...
void re_phai()
{
  ...
  analogWrite(PWM_PIN_R_B, 0);
  delay(50); // Giảm từ 100ms xuống 50ms, bạn có thể thử với 20ms hoặc 0ms.
